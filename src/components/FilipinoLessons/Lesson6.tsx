...
// this is for lesson 6 as it is for sentences for missing words
...
const Lesson6: React.FC = () => {
  ...
  if (currentQuestion >= questions.length) {
    return (
      <View style={styles.container}>
        <Text style={styles.text}>You've completed the 6th lesson</Text>
        <TouchableOpacity
          style={styles.button}
  ...
  async function finishedLessonForAccoladePosting(){
    ...
    fetch('http://localhost:3000/addAccolade', {
      ...
      body: JSON.stringify({accolade:"LessonTestLesson6.1Final"})
  })
