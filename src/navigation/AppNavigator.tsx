...
function AppNavigator() {
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="FilipinoLearning">
        ...
        {/* MAIN DASHBOARD (ONLY ONE INSTANCE) */}
        <Stack.Screen
          name="FilipinoLearning"
          component={FilipinoLearning}
          options={{ headerShown: false }}
        />

        {/* FLASHCARDS */}
        <Stack.Screen
          name="FilipinoFlashHome"
          component={FilipinoFlashHome}
          options={{ headerShown: false }}
        />
        ...
        {/* QUIZZES */}
        <Stack.Screen
          name="FilipinoQuizzes"
          component={FilipinoQuizzes}
          options={{ headerShown: false }}
        />
        ...
        {/* LESSONS */}
        <Stack.Screen
          name="FilipinoLessons"
          component={FilipinoLessons}
          options={{ headerShown: false }}
        />
